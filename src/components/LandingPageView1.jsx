      ...
      <div className="max-w-6xl mx-auto px-4 py-8 pt-[100px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <Card>
              <CardContent className="pt-6 rounded-lg">
                <div className="flex flex-col items-center">
                  ...
                  <Badge
                    variant="secondary"
                    className="hover:bg-light mt-2 p-2  shadow-md text-white bg-dark"
                  >
                  ...
                  <div className="flex flex-col gap-4 ">
                    {musicPlatformLinks.map((link) => (
                      <button
                        ...
                        className="flex items-center p-2 hover:bg-light rounded-full shadow-md bg-[#391457] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 text-white hover:text-black"
                        onClick={() =>
          ...
          >
            ...
            <motion.div id="videos" initial={{opacity:0}}
              whileInView={{opacity:1,
                transition:{
                  duration:2
                }
            ...
            <ScrollArea className="">
              ...
              <motion.div id="performances" className="mt-8"
              initial={{opacity:0}}
              whileInView={{opacity:1,
                transition:{
                  duration:2
              ...
              {/* Songs sales Section */}
              <motion.div id="songsSale" initial={{opacity:0}}
              whileInView={{opacity:1,
                transition:{
                  duration:2
                }
              ...
              {/* Merchandise Section */}
              <motion.div id="merchandise" initial={{opacity:0}}
              whileInView={{opacity:1,
                transition:{
                  duration:2
                }
              ...
              {/* Messages Section */}
              <motion.div id="messages" initial={{opacity:0}}
              whileInView={{opacity:1,
                transition:{
                  duration:2
                }
              ...
              {/* Support Section */}
              <motion.div id="support" initial={{opacity:0}}
              whileInView={{opacity:1,
                transition:{
                  duration:2
                }
